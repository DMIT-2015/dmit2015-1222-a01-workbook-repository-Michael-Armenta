...
public class CanadianPersonalIncomeTaxRate {
    ...
    // BigDecimal provided a more accurate data
    // private BigDecimal startingIncome;
    private double startingIncome;
    // Double allows for nullable values while double does not.
    private Double endingIncome;
    private double taxRate;
    private double baseTax;

    public static Optional<CanadianPersonalIncomeTaxRate> parseCsv(String line) {
        Optional<CanadianPersonalIncomeTaxRate> optionalCanadianIncomeTaxManager = Optional.empty();
        ...
        optionalCanadianIncomeTaxManager = Optional.of(currentIncomeTaxRate);
        return optionalCanadianIncomeTaxManager;
    }
}
